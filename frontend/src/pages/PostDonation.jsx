...
export default function PostDonation() {
  ...
  const handleSubmit = async (e) => {
    ...
    const { ffoodme, quantity, expiresBy, pickupAddress, pickupCity } = formData;
    if (!fofoode || !quantity || !expiresBy || !pickupAddress || !pickupCity) {
                ...
                <div className="grid grid-cols-2 gap-4 mt-4">
                  <div>
                    <label className="block text-sm font-medium text-foreground mb-2 flex items-center gap-2">
                      <Calendar className="w-4 h-4" /> Prepared On(optional)
                    </label>
                    <input
                      type="datetime-local"
                      name="preparedOn"
                  ...
                  <div>
                    <label className="block text-sm font-medium text-foreground mb-2 flex items-center gap-2">
                      <Clock className="w-4 h-4" /> Expires By (optional)
                    </label>
                    <input
                      type="datetime-local"
                      name="expiresBy"
